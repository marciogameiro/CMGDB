...
class BoxMapDataLinear:
    """Define a box map from datasets X and Y, where the points in Y are the images
       ...
       This is the original implementation, which finds the points inside a rectangle
       by a linear scan of the full dataset on every query. It is kept as the
       reference implementation; BoxMapData is a drop-in replacement that computes
       identical results using a spatial index."""
